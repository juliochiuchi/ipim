...
const MONTHS = [
  { value: '2026-1', label: 'Janeiro/2026' },
  { value: '2026-2', label: 'Fevereiro/2026' },
  { value: '2026-3', label: 'Março/2026' },
  { value: '2026-4', label: 'Abril/2026' },
  { value: '2026-5', label: 'Maio/2026' },
  { value: '2026-6', label: 'Junho/2026' },
  { value: '2026-7', label: 'Julho/2026' },
  { value: '2026-8', label: 'Agosto/2026' },
  { value: '2026-9', label: 'Setembro/2026' },
...
export default function Plan() {
  const [selectedMonth, setSelectedMonth] = useState('2026-1');
  ...
  const getEventsByMonth = async (selectedMonth: string) => {
    try {
      ...
      console.log(error)
      // adicionar uma notificacao de erro aqui      
    }
  }
