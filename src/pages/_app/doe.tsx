  ...
  return (
    <>
      <div className="min-h-screen w-full bg-gradient-to-br from-ipimBgDark via-zinc-900 to-zinc-800 dark:from-zinc-900 dark:via-zinc-800 dark:to-zinc-700">
        ...
        <div className="w-full bg-gradient-to-r from-zinc-900/90 to-zinc-800/90 backdrop-blur-sm border-b border-zinc-700/50">
          <div className="mx-auto max-w-6xl px-6 py-12 phone:px-4 phone:py-8">
            <div className="text-center">
              <h1 className="text-5xl font-bold text-white font-poppins mb-4 phone:text-3xl tablet:text-4xl laptopLg:text-6xl">
                Contribua com a IPIM
              </h1>
              <p className="text-xl text-zinc-300 font-source phone:text-lg tablet:text-xl laptopLg:text-2xl max-w-3xl mx-auto">
        ...
        {/* Main Content */}
        <div className="mx-auto max-w-6xl p-6 phone:p-4 laptopLg:p-8 desktop:p-12">
          <div className="grid gap-8 phone:gap-6 tablet:gap-8 laptopMd:grid-cols-2 laptopLg:gap-12">
            ...
            <div className="bg-gradient-to-br from-zinc-800/50 to-zinc-900/50 backdrop-blur-sm rounded-3xl border border-zinc-700/30 shadow-2xl overflow-hidden">
              <div className="p-8 phone:p-6 laptopLg:p-10">
                ...
                <div className="space-y-4">
                  ...
                  <div className="bg-zinc-900/50 border border-zinc-700/50 rounded-xl p-4 flex items-center justify-between gap-3">
                    ...
                    <button
                      ...
                      className={`px-4 py-2 rounded-lg font-inter text-sm font-medium transition-all duration-200 flex items-center gap-2 ${
                        copied 
            ...
            <div className="space-y-6">
              {/* Bank Transfer */}
              <div className="bg-gradient-to-br from-zinc-800/50 to-zinc-900/50 backdrop-blur-sm rounded-3xl border border-zinc-700/30 shadow-2xl overflow-hidden">
                <div className="p-6 phone:p-5 laptopLg:p-8">
