...
export function FindMe() {
  return (
    <section className="mx-auto my-0 flex w-full items-center justify-center bg-white px-0 py-20 dark:bg-ipimBgDark phone:px-4 phone:py-16">
      <div className="flex flex-col items-center justify-center gap-10 rounded-2xl text-center phone:w-full laptop:w-[90%] laptop:w-[50%]">
        <div className="flex gap-10 phone:flex-col phone:flex-wrap laptop:mt-0 laptop:w-[50%] laptop:flex-row laptop:flex-nowrap laptop:items-center laptop:justify-between">
          <div className="phone:w-auto laptop:w-[50%]">
          ...
          <div className="phone:w-auto phone:px-6 laptop:w-[50%] laptop:px-0">
            <span className="font-source italic text-ipimBgDark dark:text-white phone:text-[.9rem] laptop:text-[1.1rem]">
