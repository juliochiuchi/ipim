    ...
    <section className="py-16 tablet:py-20">
      <PageContainer>
        <div className="group relative rounded-3xl bg-gradient-to-r from-ipimIndigoLight to-ipimIndigoDark p-[2px] shadow-2xl transition-all hover:shadow-ipimIndigoLight/20">
          <div className="relative h-full w-full overflow-hidden rounded-[calc(1.5rem-2px)] bg-white p-6 tablet:p-10 laptop:p-14 dark:bg-ipimBgDark">
            ...
            <div className="relative z-10 grid gap-10 tablet:gap-12 tablet:grid-cols-2 tablet:items-center">
              <div className="flex flex-col gap-6 text-center tablet:text-left">

                <div className="mx-auto inline-flex w-fit items-center rounded-full bg-indigo-50 px-4 py-1.5 text-sm font-medium text-indigo-600 dark:bg-indigo-950/30 dark:text-indigo-400 tablet:mx-0">
                  <span className="mr-2 h-2 w-2 rounded-full bg-indigo-500 animate-pulse" />
                  Viva o seu chamado
                </div>

                <div className="space-y-4">
                  <h2 className="font-poppins text-3xl tablet:text-4xl laptop:text-5xl font-bold leading-tight text-ipimBgDark dark:text-white">
                    Sua jornada começa aqui
                  </h2>
                  <p className="font-source text-base tablet:text-lg text-gray-600 dark:text-gray-300 leading-relaxed max-w-xl mx-auto tablet:mx-0">
                ...
                <div className="hidden tablet:block pt-2">
              ...
              <div className="relative rounded-2xl bg-gray-50/80 p-5 tablet:p-6 backdrop-blur-sm dark:bg-zinc-900/50 border border-gray-100 dark:border-zinc-800 transition-all hover:border-indigo-100 dark:hover:border-indigo-900/50">
                <div className="space-y-6">
                  ...
                  <div className="pt-1">
                    <Button
                      asChild
                      size="lg"
                      className="w-full group/btn h-auto rounded-xl bg-gradient-to-r from-ipimIndigoLight to-ipimIndigoDark px-6 py-4 text-base tablet:text-lg font-bold text-white shadow-lg shadow-ipimIndigoLight/30 transition-all duration-300 hover:scale-[1.01] hover:shadow-xl hover:shadow-ipimIndigoLight/40"
                    >
                      <a
