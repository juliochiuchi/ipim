	...
	theme: {
		extend: {
			fontFamily: {
				...
				'sans': ['Inter', 'ui-sans-serif', 'system-ui'], // Inter como padrão
			},
			colors: {
				ipimGreen: '#009683',
				ipimGreenHover: '#04584E',
				ipimGreenDark: '#065F46',
				ipimGreenLight: '#D1FAE5',
				...
				ipimTextDark: '#a1a1aa',
				ipimGold: '#B8860B',
				ipimGoldLight: '#DAA520',
				ipimGoldDark: '#8B6914',
				ipimNavy: '#1E3A5F',
				ipimNavyLight: '#2D4A6F',
				ipimNavyDark: '#152A45',
				ipimCream: '#FAF7F0',
				ipimCreamDark: '#F5F0E6',
				ipimBurgundy: '#722F37',
				ipimBurgundyLight: '#9B3B45',
				ipimHeaderBg: '#FFFFFF',
				ipimHeaderBorder: '#E5E7EB',
				ipimHeaderShadow: 'rgba(30, 58, 95, 0.08)',
