export default function ChurchOperation() {
  return (
    <section className="bg-ipimBgSectionNextStep pt-14 dark:bg-zinc-900">
      <div className="flex justify-center laptopMd:justify-between flex-wrap gap-3 px-6">
      ...
      <div className="mt-10 flex items-start justify-center laptopMd:justify-start flex-wrap gap-3 px-6">
        ...
        <div className="flex flex-col gap-10 flex-1 text-center">
          <p className="text-5xl laptopMd:text-7xl font-poppins font-stretch-extra-expanded font-extrabold">
            Estamos te esperando!
          </p>

          <div className="flex flex-col gap-3">
            <p className="text-3xl laptopMd:text-5xl font-poppins font-stretch-extra-expanded font-bold">IPI</p>
            <p className="text-2xl laptopMd:text-4xl font-poppins font-stretch-extra-expanded font-bold">MACAUBAL</p>
          </div>

          <p className="text-lg laptopMd:text-2xl font-poppins font-stretch-extra-expanded underline">
            Rua Jeronimo Narciso Ramos 889
          </p>

          <div className="flex flex-col gap-3">
            <p className="text-xl laptopMd:text-3xl font-poppins font-stretch-extra-expanded font-bold">
              QUARTA 19h30
            </p>
      ...
      <div className="bg-[#008785] color-white py-14 flex flex-wrap items-center justify-around mt-10 gap-6 px-6">
        <div className="flex flex-col gap-3 items-center text-center laptopMd:items-start laptopMd:text-left">
      ...
      <div className="bg-[#000] color-white py-14 flex flex-wrap items-center justify-center gap-6 px-6">
        <div className="flex flex-col gap-3 max-w-[600px] items-center text-center laptopMd:items-start laptopMd:text-left">
