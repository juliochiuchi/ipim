...
export function VisitUs() {
  return (
    <section className="mx-auto w-full px-4 py-20 tablet:w-[90%] tablet:w-[80%]">
      <div className="group relative rounded-3xl bg-gradient-to-r from-ipimIndigoLight to-ipimIndigoDark p-[2px] shadow-2xl transition-all hover:shadow-ipimIndigoLight/20">
        <div className="relative h-full w-full overflow-hidden rounded-[calc(1.5rem-2px)] bg-white p-8 dark:bg-ipimBgDark tablet:p-16">
          ...
          <div className="relative z-10 grid gap-12 tablet:grid-cols-2 tablet:items-center">
            <div className="flex flex-col gap-6 text-center tablet:text-left">
              ...
              <div className="space-y-4">
                <h2 className="font-poppins text-3xl font-bold leading-tight text-ipimBgDark dark:text-white tablet:text-5xl">
                  Sua jornada começa aqui
                </h2>
                <p className="font-source text-lg text-gray-600 dark:text-gray-300 tablet:text-xl max-w-xl">
